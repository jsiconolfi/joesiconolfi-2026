...
export const TIMELINE: TimelineEra[] = [
  ...
  },
  {
    ...
    location: 'New York City',
    type: 'compact',
    summary: 'UX/UI design for MTV digital properties, including interactive voting features. The voting work drove a 55% lift in engagement.',
    artifacts: [
      { label: 'impact', value: '55% lift in user engagement' },
      { label: 'focus', value: 'editorial platforms, interactive voting' },
    ],
  },
  {
    id: 'logic',
  ...
  },
  {
    ...
    type: 'full',
    summary: 'Building a voice-first brainstorming tool that listens, clusters, and surfaces patterns in the background while you keep thinking out loud.',
    artifacts: [
      { label: 'pattern', value: 'voice-first brainstorming' },
      { label: 'innovation', value: 'AI clustering and semantic mapping' },
      { label: 'stack', value: 'TypeScript, React, Tailwind, Swift, SwiftUI' },
    ],
    tech: ['TypeScript', 'React', 'Tailwind', 'Swift', 'SwiftUI'],
    slug: 'seudo',
  ...
  },
  {
    id: 'wafer',
    years: '2025–present',
    company: 'Wafer Systems',
    role: 'Design Lead (product, visual, and UX design)',
    location: 'San Francisco',
    type: 'full',
    summary: 'Designing the context layer for a new kind of smartphone OS. Building a visual language and interaction model for a system that understands you across everything and surfaces the right capability at the right moment.',
    artifacts: [
      { label: 'product', value: 'Wafer OS: AI-native OS' },
      { label: 'visual', value: 'Visual language and component system' },
      { label: 'interaction', value: 'Proactive interaction model' },
      { label: 'scope', value: 'product, visual, UX design' },
    ],
    slug: 'wafer',
  },
]
