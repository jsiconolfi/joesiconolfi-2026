...
export const TIMELINE: TimelineEra[] = [
  {
    ...
    type: 'compact',
    summary: 'First professional role. Designed and built web experiences for local and national clients. Where craft began.',
    artifacts: [
  ...
  },
  {
    ...
    type: 'compact',
    summary: 'Award-winning agency work solving complex communication problems through design and development.',
    artifacts: [
  ...
  },
  {
    ...
    type: 'compact',
    summary: 'Led interaction design engineering for an enterprise ad creation platform serving large-scale advertising clients. First taste of building systems at scale.',
    artifacts: [
  ...
  },
  {
    ...
    location: 'New York City',
    type: 'compact',
    summary: 'Led UX engineering for MTV digital properties including interactive voting experiences. Increased user engagement by 55% on key projects.',
    artifacts: [
  ...
  },
  {
    ...
    location: 'New York City',
    type: 'compact',
    summary: 'Led design and front-end development for a fintech platform. Built and maintained design systems that streamlined development workflows. First serious design system work.',
    artifacts: [
